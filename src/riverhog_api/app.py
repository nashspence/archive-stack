...
from riverhog_core.stores.s3_support import delete_keys_with_prefixes, ensure_bucket_exists

_LOG = logging.getLogger(__name__)
_TEST_CONTROL_ENV = "RIVERHOG_ENABLE_TEST_CONTROL"
_TEST_WEBHOOK_CAPTURE_PATH_ENV = "RIVERHOG_TEST_WEBHOOK_CAPTURE_PATH"
...
def _reset_runtime_state() -> None:
    ...
    from riverhog_core import catalog_models as _catalog_models  # noqa: PLC0415
