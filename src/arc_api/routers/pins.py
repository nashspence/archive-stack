...
from arc_api.schemas.pins import PinRequest, PinResponse, PinsResponse, ReleaseRequest, ReleaseResponse
...
def list_pins(container: ServiceContainer = Depends(get_container)) -> PinsResponse:
