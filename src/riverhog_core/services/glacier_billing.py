...
from riverhog_core.stores.s3_support import _require_boto3
...
def _billing_scope(config: RuntimeConfig) -> _CostExplorerScope:
    ...
    return _CostExplorerScope(
        ...
        notes=(
            ...
            (
                "Set RIVERHOG_GLACIER_BILLING_TAG_KEY and RIVERHOG_GLACIER_BILLING_TAG_VALUE "
...
def _resolve_billing_exports(config: RuntimeConfig) -> GlacierBillingExportView:
    ...
    if export_location is None:
        return _unavailable_exports_view(
            "Set RIVERHOG_GLACIER_BILLING_EXPORT_BUCKET and RIVERHOG_GLACIER_BILLING_EXPORT_PREFIX "
