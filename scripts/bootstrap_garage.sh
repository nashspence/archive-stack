...
archive_access_key_id="$(compose_env_value RIVERHOG_ARCHIVE_ACCESS_KEY_ID "${access_key_id}")"
archive_secret_access_key="$(
  compose_env_value RIVERHOG_ARCHIVE_SECRET_ACCESS_KEY "${secret_access_key}"
)"
archive_bucket="$(compose_env_value RIVERHOG_ARCHIVE_BUCKET "${bucket}")"
