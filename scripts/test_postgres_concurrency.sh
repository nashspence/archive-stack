...
read -r -a postgres_tests <<< "${POSTGRES_TESTS:-tests/integration/test_catalog_schema_postgres.py tests/integration/test_collection_deletion_concurrency.py tests/integration/test_download_allowance_concurrency.py}"
