"""Separate target and sampler processes from one NVENC AV1 + Opus image."""
...
from stove0_nvenc_av1_opus_target.sampler import NvencAv1OpusReviewSampler
from stove0_nvenc_av1_opus_target.target import NvencAv1OpusTargetService

TARGET_SERVICE = "stove0-nvenc-av1-opus-target"
SAMPLER_SERVICE = "stove0-nvenc-av1-opus-sampler"
...
def create_sampler_app(*, token: str, sampler: NvencAv1OpusReviewSampler) -> FastAPI:
    return _create_app(
        role="sampler",
...
def sampler_main(argv: Sequence[str] | None = None) -> int:
    prefix = "STOVE0_NVENC_AV1_OPUS_SAMPLER"
