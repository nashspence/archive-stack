...
def test_loads_standalone_munchy_encode_profile_document(tmp_path) -> None:  # type: ignore[no-untyped-def]
...
def test_loads_profiles_from_munchy_job_config(tmp_path) -> None:  # type: ignore[no-untyped-def]
