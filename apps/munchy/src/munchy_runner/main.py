...
EVENT_REPEAT_TIME = normalize_event_repeat_time(os.getenv("MUNCHY_RUNNER_EVENT_REPEAT_TIME"))
EVENT_REPEAT_TIMEZONE = os.getenv("MUNCHY_RUNNER_EVENT_REPEAT_TIMEZONE", "UTC").strip() or "UTC"
event_repeat_zone(EVENT_REPEAT_TIMEZONE)
EVENT_SOURCE = os.getenv("MUNCHY_RUNNER_EVENT_SOURCE", "urn:munchy").strip()
EVENT_CONTEXT_RETENTION = parse_duration(os.getenv("MUNCHY_RUNNER_EVENT_CONTEXT_RETENTION", "30d"))
