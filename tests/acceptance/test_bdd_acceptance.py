...
scenarios("features/api.storage.feature")
scenarios("features/cli.arc.feature")
scenarios("features/cli.arc_disc.feature")
scenarios("features/cli.arc_disc_burn.feature")
