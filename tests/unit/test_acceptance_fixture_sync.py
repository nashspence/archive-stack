...
from tests.fixtures.acceptance import (
    AcceptanceArchiveReportingService,
    AcceptanceArchiveRestoreService,
    AcceptanceArchiveUploadService,
    AcceptanceCollectionService,
    AcceptanceDiscService,
...
SERVICE_SYNC_CONTRACTS = {
    ...
    "archive_uploads": (AcceptanceArchiveUploadService, ArchiveUploadService),
    "archive_reporting": (AcceptanceArchiveReportingService, ArchiveReportingService),
    "archive_restores": (AcceptanceArchiveRestoreService, ArchiveRestoreService),
    "discs": (AcceptanceDiscService, DiscService),
...
LOCKED_HELPER_STATE_ACCESS = {
    ...
    "wait_for_collection_archive_state": "polls collection archive fixture state directly",
    "defer_collection_archive_archiving": "temporarily holds collection archive upload state",
    "mark_collection_archive_uploaded": "mutates collection archive state directly",
    "collection_archive_failure_configured": "reads collection archive failure fixture state",
    "collection_archive_failure": "reads collection archive failure fixture state",
    "fail_collection_archive_upload": "mutates collection archive failure fixtures directly",
    "clear_collection_archive_upload_failure": "clears collection archive failure fixtures",
    "start_collection_archive_archiving": "mutates collection archive upload state directly",
    "seed_candidate_for_collection": "mutates candidate image fixture state directly",
    "ensure_disc_rebuild_restore": "mutates archive restore fixture state directly",
