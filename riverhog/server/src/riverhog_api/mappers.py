...
def map_archive(summary: ArchiveCopyStatus) -> dict[str, object]:
    return {
        ...
        "storage_adapter": summary.storage_adapter,
        "storage_profile_id": summary.storage_profile_id,
        "storage_profile_contract_sha256": summary.storage_profile_contract_sha256,
        "egress_accounting_id": summary.egress_accounting_id,
        "read_mode": summary.read_mode,
        "adapter_implementation_id": summary.adapter_implementation_id,
        "adapter_implementation_version": summary.adapter_implementation_version,
        "adapter_source_revision": summary.adapter_source_revision,
        "adapter_runtime_descriptor_sha256": summary.adapter_runtime_descriptor_sha256,
