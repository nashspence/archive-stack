...
def _archive_copy_status(
    ...
    *,
    ...
    return ArchiveCopyStatus(
        ...
        storage_adapter=archive.storage_adapter,
        storage_profile_id=archive.storage_profile_id,
        storage_profile_contract_sha256=archive.storage_profile_contract_sha256,
        egress_accounting_id=archive.egress_accounting_id,
        read_mode=archive.read_mode,
        adapter_implementation_id=archive.adapter_implementation_id,
        adapter_implementation_version=archive.adapter_implementation_version,
        adapter_source_revision=archive.adapter_source_revision,
        adapter_runtime_descriptor_sha256=archive.adapter_runtime_descriptor_sha256,
